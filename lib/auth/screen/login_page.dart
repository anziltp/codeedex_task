import 'package:codeedex_task/auth/screen/passwordreset_page.dart';
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  focusedBorder: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(w * 0.02),
                                    borderSide: BorderSide.none, // Removes underline when focused
                                  ),
                                  enabledBorder: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(w * 0.02),
                                    borderSide: BorderSide.none, // Removes underline when not focused
                                  ),
                                  hintText: "Enter your email",
                                  labelText: "Email",
                                  hintStyle: const TextStyle(
                                    color: Colors.black45, // Adjusted color for visibility
                                    fontWeight: FontWeight.bold,
                                  ),
